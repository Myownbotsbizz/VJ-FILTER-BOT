...
auth_channel = environ.get('AUTH_CHANNEL', '-1001571685216') # give your force subscribe channel id here else leave it blank
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1001571685216')
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://amaru:amaru@cluster0.dqd8rqm.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/moviesbizzchat')
